package com.redutec.readingoceanhome.config;
...
public class SwaggerConfig {
	 ...
	 */
	@Bean
	public OpenAPI readingOceanHomeAPI() {
		// API 정보 설정
		Info info = new Info()
				.title("Reading Ocean Home API")
				.version("v2")
				.description("Reading Ocean Home API Collection");
		// OpenAPI 객체 생성 및 설정
		return new OpenAPI()
				.addServersItem(new Server().url("/api/ro-home"))
