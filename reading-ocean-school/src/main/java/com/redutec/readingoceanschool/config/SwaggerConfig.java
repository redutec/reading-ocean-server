package com.redutec.readingoceanschool.config;
...
public class SwaggerConfig {
	 ...
	 */
	@Bean
	public OpenAPI readingOceanSchoolAPI() {
		// API 정보 설정
		Info info = new Info()
				.title("Reading Ocean School API")
				.version("v2")
				.description("Reading Ocean School API Collection");
		// OpenAPI 객체 생성 및 설정
		return new OpenAPI()
				.addServersItem(new Server().url("/api/ro-school"))
