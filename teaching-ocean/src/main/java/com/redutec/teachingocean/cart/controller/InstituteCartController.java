...
import com.redutec.teachingocean.cart.service.InstituteCartService;
...
public class InstituteCartController {
    ...
    @Operation(summary = "티칭오션몰 - 특정 상품 선택 - 장바구니에 추가", description = "현재 로그인한 교육기관의 장바구니에 선택한 상품들을 추가")
    @PostMapping
    ...
    @Operation(summary = "티칭오션몰 - 장바구니", description = "현재 로그인한 교육기관의 장바구니에 담긴 상품 조회")
    @GetMapping
    ...
    @Operation(summary = "티칭오션몰 - 장바구니 비우기", description = "현재 로그인한 교육기관의 장바구니를 비우기")
    @PatchMapping
