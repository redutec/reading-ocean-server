package com.redutec.admin.policy.mapper;
...
public class PolicyMapper {
    /**
     * CreatePolicyRequest DTO를 기반으로 Policy 엔티티를 생성합니다.
     *
     * @param createPolicyRequest 정책 생성에 필요한 데이터를 담은 DTO
     * @return 생성된 Policy 엔티티
     */
    public Policy toEntity(PolicyDto.CreatePolicyRequest createPolicyRequest) {
