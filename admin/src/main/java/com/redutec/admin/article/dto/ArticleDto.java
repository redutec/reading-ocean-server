...
public class ArticleDto {
    @Schema(description = "게시물(배너, 팝업, FAQ 등) 등록 요청 객체")
    @Builder
    @Getter
    @AllArgsConstructor
    ...
    @Schema(description = "게시물(배너, 팝업, FAQ 등) 수정 요청 객체")
    @Builder
    @Getter
    @AllArgsConstructor
    ...
    public static class BannerResponse {
        ...
        public static BannerResponse fromEntity(
            ...
            return BannerResponse.builder()
                    ...
                    .displayYn(article.getDisplayYn())
                    .displayOrder(Integer.valueOf(articleDisplay.getDisplayOrder()))
                    .bannerType(articleDisplay.getBannerType())
                    .backgroundColor(articleDisplay.getBackgroundColor())
                    .textColor(articleDisplay.getTextColor())
                    .displayBeginDatetime(articleDisplay.getDisplayBeginDatetime())
                    .displayEndDatetime(articleDisplay.getDisplayEndDatetime())
                    .linkUrl(articleDisplay.getLinkURL())
                    .displayNewWindowYn(articleDisplay.getDisplayNewWindowYn())
