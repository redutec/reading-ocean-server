...
public interface AuthenticationService {
     ...
     */
    AdminAuthenticationDto.LoginResponse login(AdminAuthenticationDto.LoginRequest loginRequest);
     ...
     */
    AdminAuthenticationDto.AuthenticatedAdminUser getAuthenticatedAdminUser();
     ...
     */
    void resetPassword(AdminAuthenticationDto.ResetPasswordRequest resetPasswordRequest) throws MessagingException;
     ...
     */
    void updatePassword(AdminAuthenticationDto.UpdatePasswordRequest updatePasswordRequest);
     ...
     */
    AdminAuthenticationDto.LoginResponse refreshAccessToken(String refreshToken);
