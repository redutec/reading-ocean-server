...
public class SubscriptionPlanController {
    ...
    public ResponseEntity<ApiResponseBody> get(@PathVariable Long subscriptionPlanId) {
        return apiResponseManager.ok(subscriptionPlanService.get(subscriptionPlanId));
    }
