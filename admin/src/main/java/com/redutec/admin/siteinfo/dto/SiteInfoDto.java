package com.redutec.admin.siteinfo.dto;
...
public class SiteInfoDto {
    ...
    @Getter
    @AllArgsConstructor
    public static class CreateSiteInfoRequest {
    ...
    @Getter
    @AllArgsConstructor
    public static class FindSiteInfoRequest {
    ...
    @Getter
    @AllArgsConstructor
    public static class UpdateSiteInfoRequest {
    ...
    public static class SiteInfoResponse {
        ...
        public static SiteInfoResponse fromEntity(CmtConfigurationGeneral cmtConfigurationGeneral) {
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    public static class SiteInfoPageResponse {
        @Schema(description = "사이트 설정 목록")
        private List<SiteInfoResponse> siteInfoList;
