...
public class ExceptionResponseHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiResponseBody> handleBadRequestException(Exception e) {
    ...
    public ResponseEntity<ApiResponseBody> handleUnauthorizedException(Exception e) {
    ...
    public ResponseEntity<ApiResponseBody> handleForbiddenException(Exception e) {
    ...
    public ResponseEntity<ApiResponseBody> handleNotFoundException(Exception e) {
    ...
    public ResponseEntity<ApiResponseBody> handleMethodNotAllowedException(Exception e) {
    ...
    public ResponseEntity<ApiResponseBody> handleNotAcceptableException(Exception e) {
    ...
    public ResponseEntity<ApiResponseBody> handleRequestTimeoutException(Exception e) {
    ...
    public ResponseEntity<ApiResponseBody> handleConflictException(Exception e) {
    ...
    public ResponseEntity<ApiResponseBody> handleResponseStatusException(ResponseStatusException e) {
        log.error("handle ResponseStatusException: {}", e.getReason());
        return apiResponseManager.error(
    ...
    public ResponseEntity<ApiResponseBody> handleUnsupportedMediaTypeException(Exception e) {
    ...
    public ResponseEntity<ApiResponseBody> handleServerException(Exception e) {
     ...
     */
    private ResponseEntity<ApiResponseBody> logAndRespond(HttpStatus status, Exception e) {
